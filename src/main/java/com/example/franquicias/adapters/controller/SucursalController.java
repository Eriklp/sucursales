...
public class SucursalController {
    ...
    @PatchMapping("/{sucursalId}/actualizar-nombre")
    public Mono<ResponseEntity<Sucursal>> actualizarNombreSucursal(@PathVariable Long sucursalId, @RequestParam String nuevoNombre) {
